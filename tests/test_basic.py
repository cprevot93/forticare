...
class BasicTestSuite(unittest.TestCase):
    ...
    def test_asset_class(self):
        ...
        self.assertTrue(asset.product_model == "FortiGSLB Cloud")
        self.assertTrue(asset.registration_date == dt.datetime(2020, 9, 23, 2, 46, 42))
        self.assertTrue(asset.description == "")
        self.assertTrue(asset.is_decommissioned is False)
        ...
        self.assertTrue(asset.entitlements[1].level_desc == "Premium")
        self.assertTrue(asset.entitlements[1].type == 12)
        self.assertTrue(asset.entitlements[1].type_desc == "Telephone Support")
        self.assertTrue(asset.entitlements[1].start_date == dt.datetime(2020, 9, 23, 0, 0))
        self.assertTrue(asset.entitlements[1].end_date == dt.datetime(2021, 9, 23, 0, 0))
        self.assertTrue(isinstance(asset.entitlements[3], Service))
        self.assertTrue(asset.entitlements[3].level == 6)
        self.assertTrue(asset.entitlements[3].level_desc == "Web/Online")
        self.assertTrue(asset.entitlements[3].type == 120)
        self.assertTrue(asset.entitlements[3].type_desc == "FortiADC GSLB Cloud Service checks")
        self.assertTrue(asset.entitlements[3].start_date == dt.datetime(2020, 9, 23, 0, 0))
        self.assertTrue(asset.entitlements[3].end_date == dt.datetime(2021, 9, 23, 0, 0))
        self.assertTrue(isinstance(asset.warranty_supports, list))
        self.assertTrue(asset.warranty_supports == [])
        ...
        self.assertTrue(asset.product_model_eor is None)
    ...
    def test_service_class(self):
        ...
        self.assertTrue(service.level_desc == "Premium")
        self.assertTrue(service.type == 11)
        self.assertTrue(service.type_desc == "Enhanced Support")
        self.assertTrue(service.start_date == dt.datetime(2020, 9, 23, 0, 0))
        self.assertTrue(service.end_date == dt.datetime(2021, 9, 23, 0, 0))
    ...
    def test_location_class(self):
        ...
        self.assertTrue(location.country_code == "FR")
        self.assertTrue(location.state_or_province == "Ile de France")
        self.assertTrue(location.postal_code == "75000")
    ...
    def test_get_licenses(self):
        ...
        with self.subTest("Test with parameters"):
            ...
            self.assertTrue(res[0].license_number == license_number)
